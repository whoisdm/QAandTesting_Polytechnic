...
public class NewOrderTest {
    ...
    void NewOrderTest1(){
        ...
        Assertions.assertNotEquals("Помилка, послуга має бути обрана, а обсяг замовлення має бути цілим числом!", res1);
    }

    @Test
    void NewOrderTest1and2(){
        String choice = "Друк фото";
        String size = "4";
        ...
        Assertions.assertNotEquals("Помилка, некоретний номер телефону або сума оплати!", res2);
    }
}
